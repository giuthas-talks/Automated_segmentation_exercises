...
\begin{itemize}
  ...
  \item Get the example data from \url{somewhere} and run:\\
    patkit scenarios/talk\_example/
...
\frame{\frametitle{Methods and Techniques in Phonetics of Signing and Speech}
  \begin{itemize}
    ...
    \item Title and authors 21 June, anywhere on Earth
    \item Full one-page abstract 28 June, anywhere on Earth 
